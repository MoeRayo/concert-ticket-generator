<template>
  <div class="bg-washed-blue vh-100">
    <header class="tc pv3 pv3-ns">
      <h1 class="tl ph5 mt2 mb0 calisto fw5 f2-ns f3 mid-gray ">Custom Summer Concert Ticket Generator</h1>
    </header>
    <section class="ph5 flex flex-wrap justify-between">
      <div class="w-100 w-50-ns">
        ...
        <div v-for="ticket in tickets" :key="ticket.id" class="fl-ns db tc pa1 grow aspect-ratio--4x6 mb3" :class="ticket.id === imageId ? 'ba bw2 b--yellow ' : ''" @click="selectImage(ticket.id, ticket.publicId)">
          <cld-image :public-id="ticket.publicId" crop="scale" width="150" height="100"></cld-image>
        </div>
        ...
        <div class="m4 cb">
          ...
          <div class="mb3 w-90">
            ...
            <input id="concert-name" v-model="formData.concertName" type="text" name="concert-name" class="db w-100 pv3 ph2 br2 ba b--black-40 f7 bg-washed-blue" required>
          </div>

          <div class="mb3 w-90">
            <label class="mb1 ttc f7 db b" for="artist">Artist</label>
            <input id="artist" v-model="formData.artist" type="text" name="artist" class="db w-100 pv3 ph2 br2 ba b--black-40 f7 bg-washed-blue" required>
          </div>
